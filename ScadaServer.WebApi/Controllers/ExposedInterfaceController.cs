...
namespace ScadaServer.WebApi.Controllers
{
    ...
    public class ExposedInterfaceController : ControllerBase
    {
        ...
        private readonly IExposedInterfaceRepository _repo;

        public ExposedInterfaceController(IExposedInterfaceAppService appService, IExposedInterfaceRepository repo)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] ExposedInterface entity)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] ExposedInterface entity)
        {
