...
namespace ScadaServer.WebApi.Controllers
{
    ...
    public class DataConversionController : ControllerBase
    {
        ...
        private readonly IDataConversionRepository _repo;

        public DataConversionController(IDataConversionAppService appService, IDataConversionRepository repo)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] DataConversion entity)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] DataConversion entity)
        {
